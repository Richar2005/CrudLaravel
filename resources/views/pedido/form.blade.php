    ...
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="cliente_id" class="form-label">
                {{ ('Cliente Id') }}</label>
            <input type="text" name="cliente_id" class="form-select @error('cliente_id') is-invalid @enderror" value="{{ old('cliente_id', $pedido?->cliente_id) }}" id="cliente_id" placeholder="Cliente Id">
